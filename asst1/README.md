I'm using an Apple M1 Pro (8 Firestorm + 2 Icestorm cores), which by reading around are supposed to have 4 and 2 SIMD pipelines, respectively.
That said, I'm running the ispc code under neon-i32x8.
